...
# count_over_prob/estimate_dispersion now live in pipeline/common/count_dist.py
# so NFL can use the same validated implementation without importing across
# sports. Re-exported here unchanged: every existing MLB caller (and the
# MLB backtests that recorded results against it) keeps working as-is.
from pipeline.common.count_dist import count_over_prob, estimate_dispersion  # noqa: E402,F401
